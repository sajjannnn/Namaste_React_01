...
const resobj = 
{
    "_id": "68fcad62ab41e4f9c2784840",
    "statusCode": 0,
    "data": {
      "statusMessage": "done successfully",
      "pageOffset": {
        "nextOffset": "CJhlELQ4KIC4j63k457zPTCnEzgC",
        "widgetOffset": {
        ...
        },
        {
          "card": {
            "card": {
              ...
              "gandalfRequest": "{\"sortAttribute\":\"relevance\",\"isFiltered\":false,\"queryId\":\"seo-data-43bca6b8-5039-46da-935e-cdde9f114a4e\",\"seoParams\":{\"apiName\":\"FoodHomePage\",\"brandId\":\"\",\"seoUrl\":\"www.swiggy.com\",\"pageType\":\"FOOD_HOME_PAGE\",\"businessLine\":\"FOOD\"}}",
              "id": "meta_data",
              "metaInfo": {
    ...
    "tid": "8904d325-01ff-4088-8aff-328ab27a90a9",
    "sid": "nmf780a5-1a19-4a88-8dff-edfa621678dd",
    "deviceId": "fc633db4-49ed-d67d-bb44-ab317349c375",
    "csrfToken": "GJYQ0CycJLi6-9x20zrSvGhhxYLP_VwAmgmPgnpg",
    "__v": 0
  };
const resList = resobj.data.cards[1].card.card.gridElements.infoWithStyle.restaurants;
// console.log(resList[0].info);
const Body = () => {
  return (
    <div className="body">
      ...
      <div className="card-container">
        {resList.map((restaurant)  => 
          <ResCard {...restaurant} key={restaurant.info.id} />
        )}
